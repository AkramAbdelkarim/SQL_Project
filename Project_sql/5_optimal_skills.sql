/*
 ...
 - Identify skills with high demand and associate it with high average salaries for Data analyst roles. 
 - Concentracte on remote positions with specified salaries.
 - Why? Target skills that offer job security (high demand) and financial benefits (high salaries),
 offering strategic insights for career development in data analysis. 
 */
-- We will create two CTEs from the two previous queries to target this
